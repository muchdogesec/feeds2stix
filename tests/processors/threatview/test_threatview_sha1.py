...
def test_create_threatview_marking_definition():
    ...
    assert stix_as_dict(marking) == {
        ...
        "definition": {"statement": "Origin: " + threatview_sha1.THREATVIEW_SHA_FEED_URL},
        "object_marking_refs": [
            "marking-definition--94868c89-83c2-464b-929b-a1a8aa3c8487",
            "marking-definition--a1cb37d2-3bd3-5b23-8526-47a22694b7e0",
        ],
...
def test_fetch_threatview_feed():
    ...
    assert items == ["da39a3ee5e6b4b0d3255bfef95601890afd80709", "aaf4c61ddcc5e8a2dabede0f3b482cd9aea9434d"]
