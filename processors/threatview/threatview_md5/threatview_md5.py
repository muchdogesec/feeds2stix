...
PROCESSOR_METADATA = PROCESSOR_METADATA_BY_PROCESSOR["threatview_md5"]
...
def fetch_threatview_feed(data_dir: Path):
    """Fetch MD5 hashes from ThreatView feed and save raw feed."""
    ...
    raw_path = data_dir / "threatview_md5_feed.txt"
...
def create_stix_objects(
    ...
    for md5_hash in md5_hashes:
        ...
        indicator = Indicator(
            ...
            name=indicator_name,
            pattern=f"[file:hashes.MD5 = {StringConstant(md5_hash)} ]",
            pattern_type="stix",
            object_marking_refs=[
...
def main():
    ...
    try:
        ...
        md5_hashes = fetch_threatview_feed(data_dir)
